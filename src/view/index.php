...
<body>
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded bg-gray-100">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <a href="./index.php" class="flex items-center">
                <img src="../images/logo.png" class="mr-3 h-6 sm:h-9" alt="Logo elezioni" />
                <span class="self-center text-xl font-semibold whitespace-nowrap text-blue-500">Elezioni</span>
            </a>
